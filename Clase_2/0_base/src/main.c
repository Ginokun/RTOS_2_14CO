...
QMPool Pool_memoria; // memory pool (tiene la informacion que necesita la biblioteca)
...
int main( void )
{
	...
	// Reservar memoria para el memory pool
	...
	// Creo el pool de memoria que va a usarse
	QMPool_init( &Pool_memoria, (tMensaje) Pool_puntero, POOL_SIZE*sizeof(tMensaje), PACKET_SIZE )
